...
public class Solution {
    ...
    public static double getProfit(Stock stock){
        double profit = 0;
        if(stock.containsKey("open")){
            double open = (double)stock.get("open");
            double close = (double)stock.get("last");
            profit = close - open;
        }
        else{
    ...
    public static List<Stock> getStocks() {
        ...
        //stocks.add(new Stock("Fake Apple IncTest.", "AAPL", 125.64, 123.43, new Date()));
        //stocks.add(new Stock("Fake Apple IncTest.", "AAPL", 125.64, 123.53, new Date()));
